    ...
    <>
      ...
      <div className="page-wrapper">
        <div className="card">
          ...
          <p style={{ color: '#475569', marginBottom: '1.5rem', fontSize: '0.9rem' }}>Join us today</p>
          ...
          <p style={{ color: '#475569', fontSize: '0.85rem', marginTop: '1.25rem', textAlign: 'center' }}>
            ...
            <Link to="/login" style={{ color: '#0e7490', textDecoration: 'none', fontWeight: 600 }}>Sign in</Link>
          </p>
        </div>
      </div>
    </>
